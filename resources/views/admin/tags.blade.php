...
<div class="content__recipe">
    <div class="recipe__start">
        <h3 class="recipe__title">Теги</h3>
    </div>
    <form class="d-flex recipe__search" method="GET" action="{{ route('admin.searchTags', ['id' => $user->id]) }}" role="search">
        ...
        <table class="table align-middle" id="table">
          ...
          <tbody>
            ...
            <tr>
                ...
                <td><a href="{{ route('catalog.showTag', ['tag' => $val->id]) }}" class="btn btn-outline-primary">Рецепты</a></td>
            </tr>
            @endforeach
          </tbody>
        </table>
