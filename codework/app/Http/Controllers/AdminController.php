...
class AdminController extends Controller
{
    ...
    public function languageStore( Request $request) {
        $validator = Validator::make($request->all(), [
            ...
            'abbreviated' => 'required|max:50|string',
            'abbreviatedEdit' => 'required|max:50|string',
        ]);
        ...
        Language::create([
            ...
            'abbreviated' => $request->get('abbreviated'),
            'abbreviatedEdit' => $request->get('abbreviatedEdit'),
        ]);
