...
<div class="content__userInfo">
    <div class="content__userInfo__inner">
        <div>
            <img src="{{ asset('img/imageUser/'. $user->photoPath) }}" alt="" class="profile_img" style="object-fit: cover;
            width: 200px;
            height: 200px;
            border-radius: 50%;">
...
<div class="table-responsive content__userInfo" style="margin-top: 50px">
    ...
    @else
    <h5 style="margin-bottom: 15px">Рецепты пользователя: {{ $user->userInfo->name  }}</h5>
    @endif
